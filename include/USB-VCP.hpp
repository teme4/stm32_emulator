...
extern const char Configuration_Descriptor[];
...
void Send_EP0(const char *data, uint32_t len); // Send a packet on endpoint 0. Max packet lenght 64 byte.
...
#define USBInit()                                                                                                                         \
	{                                                                                                                                     \
		...
		GPIOA_CRH_USB |= 0x00044000;                                                                                                      \
		;							 /*GPIOA12 (USBDP). GPIOA11 (USBDM).*/                                                                \
