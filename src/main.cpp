...
int main()
{
  ...
  while (1)
  {
    ...
    { // If a packet has been received..
      ...
      for (ii = 0; ii < VCP_RX_LEN; ii++)
      { // Copy the received data to the transmission buffer "BUFF_TX_VCP".
      ...
      Wait_VCP_TX();
    } // Wait until the packet has been completely sent.
  }
}
